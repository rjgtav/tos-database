...
class TOSLanguage(TOSEnum):
    ...
    def to_string(value):
        return {
            TOSLanguage.ENGLISH: 'English',
            TOSLanguage.GERMAN: 'German',
            TOSLanguage.JAPANESE: 'Japanese',
            TOSLanguage.KOREAN: 'Korean',
            TOSLanguage.PORTUGUESE: 'Portuguese',
            TOSLanguage.TAIWANESE: 'Taiwanese',
        }[value]

    @staticmethod
    def value_of_region(value):
        return {
            TOSRegion.iTOS: [TOSLanguage.ENGLISH, TOSLanguage.GERMAN, TOSLanguage.PORTUGUESE],
            TOSRegion.jTOS: [TOSLanguage.JAPANESE],
            TOSRegion.kTOS: [TOSLanguage.KOREAN],
            TOSRegion.kTEST: [TOSLanguage.KOREAN],
            TOSRegion.twTOS: [TOSLanguage.TAIWANESE],
        }[value]
