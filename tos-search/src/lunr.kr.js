...
(function(root, factory) {
     ...
     */
    return function(lunr, nodejieba) {
        /* throw error if lunr is not yet included */
        if ('undefined' === typeof lunr) {
            throw new Error('Lunr is not present. Please include / require Lunr before this script.');
        }

        /* throw error if nodejieba is not yet included */
        if ('undefined' === typeof nodejieba) {
            throw new Error('nodejieba is not present. Please include / require OpenKoreanText before this script.');
        }
