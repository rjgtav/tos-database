...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 10785968,
    DYNAMIC_BASE = 10785968,
    DYNAMICTOP_PTR = 5543056;
...
var ASM_CONSTS = [function($0) { console.error('LUA_RUNTIME_CALL failed. Error: ', UTF8ToString($0)); },
 function($0) { let xhr = new XMLHttpRequest(); xhr.open('GET', UTF8ToString($0), false); xhr.setRequestHeader('Accept', 'application/json'); xhr.send(); let response; if (xhr.status == 200) { response = xhr.response; } else { response = '$ERROR$'; console.error('LUA: Failed to HttpRequest', xhr); } let responseLength = lengthBytesUTF8(response) + 1; let responseWasm = _malloc(responseLength); stringToUTF8(response, responseWasm, responseLength); return responseWasm; }];
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=5542912;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 5542960, 4), 5542960);function _gmtime_r(time, tmPtr) {
...
var real__LUA_INIT = asm["_LUA_INIT"]; asm["_LUA_INIT"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__LUA_INIT.apply(null, arguments);
};

var real__LUA_RUNTIME_CALL = asm["_LUA_RUNTIME_CALL"]; asm["_LUA_RUNTIME_CALL"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__LUA_RUNTIME_CALL.apply(null, arguments);
};
...
var _LUA_RUNTIME_CALL = Module["_LUA_RUNTIME_CALL"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_LUA_RUNTIME_CALL"].apply(null, arguments) };
