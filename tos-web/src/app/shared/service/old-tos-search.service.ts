...
export class OldTosSearchService {

  private MESSAGE_ID: number = 0;

  private static instance: OldTosSearchService;
  static get Instance(): OldTosSearchService { return OldTosSearchService.instance; }
  ...
  constructor() {
    OldTosSearchService.instance = this;

    this.onWorkerMessage = this.onWorkerMessage.bind(this);

    //this.loading.install$Complete.subscribe((value) => this.onInstallComplete(value));
  }
