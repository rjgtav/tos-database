...
export class PatreonService {
  ...
  static readonly PATRONS_KEPA = ['Ersakoz','IlIlIlIlIlIlIlI','Isa Lim','Julio Fernández','Melvin Khor','Nasrul Rodzi','Onesan','Orleen Sedoj']; /* 100-needle */
  static readonly PATRONS_POPOLION = []; /* 1000-needle */
  static readonly PATRONS_TINI = ['Kenneth Cheong','Tunico Schmidt']; /* 500-needle */
