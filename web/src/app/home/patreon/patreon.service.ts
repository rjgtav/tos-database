...
export class PatreonService {
  ...
  static readonly PATRONS_KEPA = ['Asuna','Ersakoz','Isa Lim','Julio Fernández','Kirarin','Nhr','Onesan','Palemoon','Phantasos','Team-Z','Yuuki']; /* 100-needle */
  ...
  static readonly PATRONS_KUPOLE = ['真庭赤狐']; /* 2000-needle */
