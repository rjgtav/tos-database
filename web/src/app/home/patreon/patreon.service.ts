...
export class PatreonService {
  ...
  static readonly PATRONS_KEPA = ['Daniel Hideki Momo','Ersakoz','IlIlIlIlIlIlIlI','Isa Lim','Julio Fernández','Nhr','Onesan','Orleen Sedoj','Palemoon','Thossapon Suekittisak']; /* 100-needle */
