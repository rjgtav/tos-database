...
export class PatreonService {
  ...
  static readonly PATRONS_KEPA = ['Asuna','Ersakoz','IlIlIlIlIlIlIlI','Isa Lim','Julio Fernández','Kirarin','MOoNoiiz','Nhr','Onesan','Palemoon','Team-Z','Yuuki']; /* 100-needle */
  ...
  static readonly PATRONS_KUPOLE = ['Privaron','Shinobi Runez','真庭赤狐']; /* 2000-needle */
