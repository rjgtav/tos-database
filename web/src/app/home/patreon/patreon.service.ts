...
export class PatreonService {
  ...
  static readonly PATRONS_KEPA = ['Ersakoz','IlIlIlIlIlIlIlI','Isa Lim','Julio Fernández','Nhr','Onesan','Orleen Sedoj','Palemoon']; /* 100-needle */
  static readonly PATRONS_POPOLION = []; /* 1000-needle */
  static readonly PATRONS_TINI = ['Edmund Tang','Kenneth Cheong','Tunico Schmidt']; /* 500-needle */
  static readonly PATRONS_KUPOLE = ['士允 林']; /* 2000-needle */
