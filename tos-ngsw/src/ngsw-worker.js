(function () {
  ...
  class CacheTable {
    ...
    read(key) {
      return HotFix_cache_match(this.cache, this.request(key)).then(res => {
        if (res === undefined) {
  ...
  class AssetGroup {
    ...
    cacheStatus(url) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield HotFix_cache_match(cache, this.adapter.newRequest(url));
        if (res === undefined) {
    ...
    handleFetch(req, ctx) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (this.config.urls.indexOf(url) !== -1 || this.patterns.some(pattern => pattern.test(url))) {
          ...
          // operation.
          const cachedResponse = yield HotFix_cache_match(cache, req);
    ...
    fetchFromCacheOnly(url) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield HotFix_cache_match(cache, this.adapter.newRequest(url));
    ...
    safeFetch(req) {
      return __awaiter(this, void 0, void 0, function* () {
        try {
          return yield this.scope.fetch(HotFix_safeFetch_AssetGroup(this, req));
        }
        catch (err) {
    ...
    initializeFully(updateFrom) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        yield this.config.urls.reduce((previous, url) => __awaiter(this, void 0, void 0, function* () {
          ...
          const alreadyCached = (yield HotFix_cache_match(cache, req)) !== undefined;
  ...
  class DataGroup {
    ...
    loadFromCache(req, lru) {
      return __awaiter$1(this, void 0, void 0, function* () {
        ...
        const cache = yield this.cache;
        let res = yield HotFix_cache_match(cache, req);
        if (res !== undefined) {
...
${msgIdle}`, { headers: this.adapter.newHeaders({ 'Content-Type': 'text/plain' }) });
  ...
  class Driver {
    ...
    safeFetch(req) {
      return __awaiter$5(this, void 0, void 0, function* () {
        try {
          return yield this.scope.fetch(HotFix_safeFetch_Driver(this.adapter, req));
        }
        catch (err) {
  ...
  //         Except when the service worker wants to bypass the cache (e.g. for loading the ngsw.json)
  const HotFix_safeFetch_AssetGroup = (assetGroup, req) => {
    let adapter = assetGroup.adapter;
    let hashes = assetGroup.hashes;
    let url = assetGroup.getConfigUrl(req.url);
        url = url.indexOf('ngsw-cache-bust=') === -1 && hashes.has(url)
